                ...
                <div class="post-details">
                    ...
                    <div class="post-details-info1982">
                        ...
                        <div class="post-footer29032">
                            <div class="l-side2023"> <i class="fa fa-check check2" aria-hidden="true"> kiểm tra đã trả lời chưa(kiểm duyệt)</i> <a href="#"><i class="fa fa-star star2" aria-hidden="true">  5</i></a> <i class="fa fa-folder folder2" aria-hidden="true"> wordpress</i> <i class="fa fa-clock-o clock2" aria-hidden="true"> Thời gian đăng</i> <a href="#"><i class="fa fa-commenting commenting2" aria-hidden="true"> 5 answer</i></a> <i class="fa fa-user user2" aria-hidden="true"> {{ $post->count_view }}</i> </div>
                            <div class="l-rightside39">
                                ...
                                <button type="button" class="tolltip-button  thumbs-down2" data-toggle="tooltip" data-placement="bottom" title="Dislike"><i class="fa fa-thumbs-o-down" aria-hidden="true"></i></button> <span class="single-question-vote-result">luot like</span> </div>
                        </div>
                    </div>
                </div>
                                ...
                                <ul id="comments-list" class="comments-list">
                                    <li>
                                        ...
                                        <div class="comment-main-level">
                                            ...
                                            <div class="comment-avatar"><img src="img/images.png" alt=""></div>
                                            <!-- Contenedor del Comentario -->
                                            
                                                <div class="comment-box">
                                                    <div class="comment-head">
                                                        <h6 class="comment-name"><a href="#">{{ $comment->username }}</a></h6>
                                                        <span><i class="fa fa-clock-o" aria-hidden="true"> {{$comment->create_date}}</i></span>
                        ...
                        <div class="col-md-12">
                            <div class="post9320-box">
                                <form action="{{ route('upcomment') }}" method="GET">
                                    ...
                                    <input type="text" class="comment-input219882" placeholder="Enter Your Post" name="comment"> </div>
