...
Themehttps://t.co/urb3LgsOCi</a></p> <small>about 2 weeks ago</small> </div> -->
                        ...
                        <div class="white-color about-purpose ">
                            ...
                            <p>Trang web được tạo ra nhằm cung cấp một môi trường học tập và trao đổi kiến thức cho sinh viên ngành công nghệ thông tin.</p>
                        </div>

                        <div class="white-color about-feature">
                            <h5 class="white-color" >Các tính năng của trang web:</h5>
                            <ul>
                                <li>Kho tài liệu học tập phong phú và đa dạng, bao gồm các tài liệu chính thống, tài liệu tham khảo, tài liệu thực hành, v.v.</li>
                                <li>Cộng đồng sinh viên đông đảo và nhiệt tình, luôn sẵn sàng giúp đỡ nhau trong học tập.</li>
                            </ul>
                        </div>
